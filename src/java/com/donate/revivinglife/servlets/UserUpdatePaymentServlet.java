 ...
 * @author sa451
 */
@WebServlet(name = "UserUpdatePaymentServlet", urlPatterns = {"/UserUpdatePaymentServlet"})
public class UserUpdatePaymentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        DonorPaymentDao donorpaymentDao = new DonorPaymentDao(ConnectionProvider.getConnection());
        donorpaymentDao.updatePaymentInformation(payment_id, order_id,donationType, status);
