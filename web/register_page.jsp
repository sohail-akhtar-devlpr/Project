    ...
    <body>
            ...
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    <div class="card" style="border: 2px solid orangered; border-radius:24px;">
                        ...
                        <div class="card-header my-1" style="border-radius: 24px; background: #e040fb;">
                            <label style="font-weight: bold; color: white">Donor Registration</label>
                        </div>
                        <div class="card-body">
                            <form style="border-radius:24px;" id="user-reg-form" action="RegisterServlet" method="post">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label required" for="exampleCheck1">Agree terms and conditions</label>
                                </div>
                                <br>
                                <div class="container text-center">
                                    <button style="border-radius:24px; background: orangered;color: white; font-weight: bold;" type="submit" class="btn btn-primary btn-lg">Submit</button>
                                </div>
                            </form>
                            <p class="text-center my-1">Already Registered? <a href="login_page.jsp">Login</a></p>
                        </div>
                    </div>
                </div>  
            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#user-reg-form').on('submit', function (event) {
